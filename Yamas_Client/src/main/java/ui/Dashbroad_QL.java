...
public class Dashbroad_QL extends JFrame implements ActionListener{
	/**
	 * 
	 */
	...
	public Dashbroad_QL(NhanVien nv) {
		try {
...
//			JMenuItem mnqlDichVu = new JMenuItem("Dá»‹ch Vá»¥/Phá»¥ tÃ¹ng"); mnQuanLy.add(mnqlDichVu);
//			
//			mnqlDichVu.addActionListener(new ActionListener() {
//				public void actionPerformed(ActionEvent e) {
////					doiPanel(new LayoutDichVu().getContentPane());
//				}
//			});
		...
		JMenu mnThongKe = new JMenu("Thống kê"); menuBar.add(mnThongKe);
			JMenuItem mntkNhanVien = new JMenuItem("Nhân viên"); mnThongKe.add(mntkNhanVien);
			
			mntkNhanVien.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					doiPanel(new Layout_TKNhanVien().getContentPane());
				}
			});
			JMenuItem mntkHangHoa = new JMenuItem("Sản phẩm"); mnThongKe.add(mntkHangHoa);
			
			mntkHangHoa.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
//					doiPanel(new Layout_TKmathang().getContentPane());
				}
			});
			
//			JMenuItem mntkKhachHang = new JMenuItem("KhÃ¡ch hÃ ng"); mnThongKe.add(mntkKhachHang);
//			
//			mntkKhachHang.addActionListener(new ActionListener() {
//				public void actionPerformed(ActionEvent e) {
//					//doiPanel(new Frm_TraDia().getContentPane());
//				}
//			});
			JMenuItem mntkHoaDon = new JMenuItem("Hoá đơn"); mnThongKe.add(mntkHoaDon);
			
			mntkHoaDon.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
//					doiPanel(new Layout_TKHoaDon().getContentPane());
				}
			});
			try {
				doiPanel(new Layout_ThongTinCaNhan(nv).getContentPane());
